...
function cardselect(){
    ...
    const catvalue=document.getElementById("cards").value
    const filterdata=data.filter((x)=>x.category===catvalue)
    displaycard(filterdata)

}
function displaycard(filldata){
    let cardconatiner=document.getElementById("cardcontainer")
    ...
    filldata.forEach((x)=>{
        ...
        card.innerHTML=`
        <img src=${x.image} width=120 id="imagetag">
...
let Txtarea=document.querySelector("h1")
